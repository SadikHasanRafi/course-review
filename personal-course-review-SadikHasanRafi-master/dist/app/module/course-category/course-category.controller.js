...
const addNewCourseCategory = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    res.send((0, globalResponse_1.default)(true, 201, "Category created successfully", result));
});
const getAllCourseCategory = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    res.send((0, globalResponse_1.default)(true, 200, "Categories retrieved successfully", result));
});
